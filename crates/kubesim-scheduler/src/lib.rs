...
//!
//! Built-in plugins:
//! - Filters: `NodeResourcesFit`, `TaintToleration`, `InterPodAffinity`
//! - Scorers: `MostAllocated`, `LeastAllocated`, `InterPodAffinity`
...
impl SchedulerProfile {
    ...
    pub fn with_scoring(name: impl Into<String>, scoring: ScoringStrategy) -> Self {
        ...
        Self {
            ...
            scorers: vec![scorer, Box::new(InterPodAffinityScore::new(1))],
        }
    }
}
